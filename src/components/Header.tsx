...
import { fetchStations, Station } from '../utils/api'
...
const Header: React.FC<HeaderProps> = ({ onVisibilityChange }) => {
  ...
  const [stationName, setStationName] = useState<string>('Firehouse Dashboard')

  const isActive = (path: string) => location.pathname === path

  // Fetch station name on mount
  useEffect(() => {
