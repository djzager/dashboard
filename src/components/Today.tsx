  ...
  if (loading) {
    return (
      <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 ${className}`}>
        <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Today</h2>
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 flex flex-col h-full ${className}`}>
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Today</h2>
        <button 
          onClick={fetchData}
      ...
      <div className="flex-1 space-y-4">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-semibold text-gray-900 dark:text-white">On Duty</h3>
              ...
              {Object.entries(groupedStaffing).map(([assignmentName, positions]) => (
                <div key={assignmentName} className="space-y-2">
                  ...
                  {positions.map((position, index) => (
                    <div key={index} className="bg-white dark:bg-gray-800 rounded p-3 border-l-4 border-green-400">
